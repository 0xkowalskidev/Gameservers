...
func (db *testGameserverDB) GetGame(id string) (*Game, error) {
...
func (db *testGameserverDB) CreateGameserver(gs *Gameserver) error {
	if gs.ID == "" {
		gs.ID = "test-id-1"
	}
...
func (db *testGameserverDB) GetGameserver(id string) (*Gameserver, error) {
...
func (db *testGameserverDB) UpdateGameserver(gs *Gameserver) error {
	db.gameservers[gs.ID] = gs
	return nil
}
...
func (db *testGameserverDB) ListGameservers() ([]*Gameserver, error) {
...
func (db *testGameserverDB) ListGames() ([]*Game, error)                           { return nil, nil }
func (db *testGameserverDB) CreateGame(game *Game) error                           { return nil }
func (db *testGameserverDB) CreateScheduledTask(task *ScheduledTask) error         { return nil }
func (db *testGameserverDB) GetScheduledTask(id string) (*ScheduledTask, error)    { return nil, nil }
func (db *testGameserverDB) UpdateScheduledTask(task *ScheduledTask) error         { return nil }
func (db *testGameserverDB) DeleteScheduledTask(id string) error                   { return nil }
func (db *testGameserverDB) ListScheduledTasksForGameserver(gameserverID string) ([]*ScheduledTask, error) { return nil, nil }
...
func (db *testGameserverDB) ListGameserverBackups(gameserverID string) ([]*FileInfo, error) { return nil, nil }
func (db *testGameserverDB) ListFiles(containerID string, path string) ([]*FileInfo, error) { return nil, nil }
...
func (d *testDockerManager) CreateContainer(gs *Gameserver) error {
...
func (d *testDockerManager) GetContainerStatus(containerID string) (GameserverStatus, error) {
...
func (d *testDockerManager) GetVolumeInfo(volumeName string) (*VolumeInfo, error) { return nil, nil }
func (d *testDockerManager) CleanupOldBackups(containerID string, maxBackups int) error { return nil }
func (d *testDockerManager) ListFiles(containerID string, path string) ([]*FileInfo, error) { return nil, nil }
